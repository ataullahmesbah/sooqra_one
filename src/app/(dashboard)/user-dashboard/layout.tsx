...
const UserDashboardLayout = ({ children }: UserDashboardLayoutProps) => {
    ...
    const FolderData: FolderItem[] = [
        {
            label: 'DASHBOARD',
            children: [
                { label: 'Dashboard Home', link: '/user-dashboard' },
            ],
        },
        {
            label: 'SHOP',
            children: [
                { label: 'My Orders', link: '/user-dashboard/shop/my-orders' },
                { label: 'Browse Products', link: '/user-dashboard/shop/browse-products' },
            ],
        },
        {
            label: 'ACCOUNT',
            children: [
                { label: 'Profile Settings', link: '/user-dashboard/account/profile' },
                { label: 'Payment Methods', link: '/user-dashboard/account/payments' },
            ],
        },
    ];
    ...
    // Redirect if user is not authenticated or not a normal user
    ...
    return (
        <div className="user-dashboard-layout min-h-screen flex bg-gray-900">
            ...
            >
                ...
                <div className="mb-8 p-4 bg-gray-800 rounded-lg">
                    <h2 className="text-xl font-bold text-center mb-2">User Panel</h2>
