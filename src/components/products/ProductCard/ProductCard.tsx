                        ...
                        <div className="mt-auto">
                            <div className="flex gap-2">
                                ...
                                <button
                                    onClick={handleAddToCart}
                                    disabled={isAddToCartDisabled() || isAddingToCart}
                                    className={`flex-1 px-4 py-3 font-semibold text-sm rounded-xl transition-all duration-300 shadow-md hover:shadow-lg flex items-center justify-center gap-2 ${getAddToCartButtonStyle()}`}
                                >
                                    {isAddingToCart ? (
                                    ...
                                    {showSuccess ? 'Added!' : product.productType === 'Affiliate' ? 'Affiliate' : 'Add'}
                                </button>
                            </div>
                        </div>
                    </div>
