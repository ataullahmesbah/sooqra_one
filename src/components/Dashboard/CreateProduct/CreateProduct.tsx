                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full p-3 bg-gray-800 text-white rounded-lg border ${errors.title ? 'border-red-500' : 'border-gray-700'} focus:outline-none focus:ring-2 focus:ring-purple-500`}
                        ...
                        <div className='flex gap-4 items-center'>
                            <div className="flex-1">
                                ...
                                <input
                                    ...
                                    className={`w-full p-3 bg-gray-800 text-white rounded-lg border ${errors.quantity ? 'border-red-500' : 'border-gray-700'} focus:outline-none focus:ring-2 focus:ring-purple-500`}
                            ...
                            <div className="flex-1">
                                ...
                                <input
                                    ...
                                    className={`w-full p-3 bg-gray-800 text-white rounded-lg border ${errors.product_code ? 'border-red-500' : 'border-gray-700'} focus:outline-none focus:ring-2 focus:ring-purple-500`}
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full p-3 bg-gray-800 text-white rounded-lg border ${errors.brand ? 'border-red-500' : 'border-gray-700'} focus:outline-none focus:ring-2 focus:ring-purple-500`}
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className={`w-full p-3 bg-gray-800 text-white rounded-lg border ${errors.category ? 'border-red-500' : 'border-gray-700'} focus:outline-none focus:ring-2 focus:ring-purple-500`}
                            >
                            ...
                            {formData.category === 'new' && (
                                <div className="mt-2">
                                    <input
                                        ...
                                        className={`w-full p-3 bg-gray-800 text-white rounded-lg border ${errors.newCategory ? 'border-red-500' : 'border-gray-700'} focus:outline-none focus:ring-2 focus:ring-purple-500`}
                                ...
                                {formData.usdPrice && (
                                    <div className="mt-2">
                                        ...
                                        <input
                                            ...
                                            className={`w-full pl-8 pr-4 py-3 bg-gray-800 text-white rounded-lg border ${errors.usdExchangeRate ? 'border-red-500' : 'border-gray-700'} focus:outline-none focus:ring-2 focus:ring-purple-500`}
                                            placeholder="0.00"
                                            step="0.01"
                                            min="0"
                                        />
                                ...
                                {formData.eurPrice && (
                                    <div className="mt-2">
                                        ...
                                        <input
                                            ...
                                            className={`w-full pl-8 pr-4 py-3 bg-gray-800 text-white rounded-lg border ${errors.eurExchangeRate ? 'border-red-500' : 'border-gray-700'} focus:outline-none focus:ring-2 focus:ring-purple-500`}
                                            placeholder="0.00"
                                            step="0.01"
                                            min="0"
                                        />
                        ...
                        {formData.productType === 'Affiliate' && (
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full p-3 bg-gray-800 text-white rounded-lg border ${errors.affiliateLink ? 'border-red-500' : 'border-gray-700'} focus:outline-none focus:ring-2 focus:ring-purple-500`}
                                ...
                                {formData.sizes.map((size, index) => (
                                    <div key={index} className="flex items-center mb-2 gap-4">
                                        <input
                                            ...
                                            className={`w-1/2 p-3 bg-gray-800 text-white rounded-lg border ${errors[`sizeName${index}`] ? 'border-red-500' : 'border-gray-700'} focus:outline-none focus:ring-2 focus:ring-purple-500`}
                                        ...
                                        <input
                                            ...
                                            className={`w-1/2 p-3 bg-gray-800 text-white rounded-lg border ${errors[`sizeQuantity${index}`] ? 'border-red-500' : 'border-gray-700'} focus:outline-none focus:ring-2 focus:ring-purple-500`}
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full p-3 bg-gray-800 text-white rounded-lg border ${errors.mainImageAlt ? 'border-red-500' : 'border-gray-700'} focus:outline-none focus:ring-2 focus:ring-purple-500`}
